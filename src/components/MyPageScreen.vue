            ...
            <div class="ma-10">
                ...
                <v-window v-model="tab">
                    <v-window-item :value="1">
                        ...
                        <v-container class="list mb-10" @click="goToReserved" v-for="order in orderList"
                            :key="order.ticketId">
                                                ...
                                                <v-card>
                                                    ...
                                                    <v-card-text>
                                                        <v-container>
                                                            ...
                                                            <v-row v-if="user.resultCode === '0000'" class="justify-end"
                                                                style="color: blue">
                                                                {{ user.message }}</v-row>
                                                    ...
                                                    <v-card-text>
                                                        <v-container>
                                                            <v-row>
                                                                ...
                                                                <v-col cols="8">
                                                                    <v-text-field variant="outlined" label="회원번호를 입력해주세요."
                                                                        v-model="fanId"></v-text-field>
                                                                </v-col>
                                                            </v-row>
                                                            <v-row v-if="user.resultCode === '0000'" class="justify-end"
                                                                style="color: blue">
