    ...
    <div class="ma-10 pa-10">
      ...
      <div class="ma-10">
        <v-tabs v-model="tab" color="#ff5252" align-tabs="center">
          <v-tab :value="1" style="width: 50%; font-size: 20px">예매 내역</v-tab>
          <v-tab :value="2" style="width: 50%; font-size: 20px">회원 정보 조회</v-tab>
        </v-tabs>
        <v-window v-model="tab">
          <v-window-item :value="1">
            <v-row class="justify-end mt-6">
              <v-col cols="2" class="pb-0 d-flex align-center">
                <v-select label="결제상태" v-model="searchCategory" density="compact" :items="categorieList"
                  variant="outlined"></v-select>
              </v-col>
              <v-col cols="3" class="pb-6 d-flex align-center">
                <v-text-field :loading="loading" density="compact" variant="solo" label="공연명을 입력해주세요" single-line
            ...
            <v-container class="list mb-10" @click="goToReserved" v-for="order in orderList" :key="order.ticketId">
            ...
            <v-pagination v-model="page" :length="order.totalPage" @click="handlePage"></v-pagination>
          </v-window-item>
                        ...
                        <v-card>
                          ...
                          <v-card-text>
                            <v-container>
                              ...
                              <v-row v-if="user.resultCode === '0000'" class="justify-end" style="color: blue">
                                {{ user.message }}</v-row>
                    ...
                    <td style="
                      ...
                      <v-dialog v-model="dialog2" persistent width="1024">
                        ...
                        <v-card>
                          ...
                          <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="#000000" variant="text" @click="dialog2 = false">
                              취소
                            </v-btn>
                        ...
                        <v-card>
                          ...
                          <v-card-text>
                            <v-container>
                              ...
                              <v-row><v-col style="font-weight: bolder">사용하고 계신 이메일은 탈퇴할 경우
                                  재사용 및
                                  복구가 불가능합니다.</v-col></v-row>
                              <v-row><v-col style="font-weight: bolder">탈퇴 후 회원정보 및 개인형 서비스
                                  이용기록은
                                  모두 삭제됩니다.</v-col></v-row>
                          ...
                          <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn color="#000000" variant="text" @click="dialog3 = false">
                              취소
                            </v-btn>
