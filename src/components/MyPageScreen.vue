            ...
            <div class="ma-10">
                ...
                <v-window v-model="tab">
                    <v-window-item :value="1">
                        ...
                        <v-container class="list mb-10" @click="goToReserved" v-for="i in   3  " :key=i>
                            <v-row class="justify-start">
                                ...
                                <v-col cols="8">
                                    ...
                                    <v-row class="justify-start">
                                        <v-col>
                                            <p style="font-size:30px;" class="concertDate mt-3">2023-09-23</p>
                                            <p style="font-size:20px;">잠실 실내 체육관</p>
                                        </v-col>
                                    </v-row>
                                </v-col>
                            </v-row>
                        ...
                        <v-pagination v-model="page" :length="3" @click="handlePage"></v-pagination>
                    </v-window-item>
                                            ...
                                            <v-dialog v-model="dialog2" persistent width="1024">
                                                ...
                                                <v-card>
                                                    ...
                                                    <v-card-actions>
                                                        ...
                                                        <v-btn color="#ff5252" variant="text" @click="dialog2 = false">
                                                            인증
                                                        </v-btn>
                                                    </v-card-actions>
                                                </v-card>
                                            ...
                                            <v-dialog v-model="dialog3" persistent width="1024">
                                                ...
                                                <v-card>
                                                    ...
                                                    <v-card-actions>
                                                        ...
                                                        <v-btn color="#ff5252" variant="text" @click="dialog3 = false">
                                                            탈퇴하기
                                                        </v-btn>
                                                    </v-card-actions>
                                                </v-card>
