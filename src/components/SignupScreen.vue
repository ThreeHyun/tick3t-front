  ...
  <div>
    ...
    >
      ...
      <v-text-field
        ...
        variant="outlined"
        placeholder="예) tick3t@tick-3t.com"
        label="이메일"
        type="email"
        required
        @input="emailValid"
      ...
      <v-text-field
        ...
        label="비밀번호 확인"
        maxlength="16"
        @input="userPwdCheckValid"
        required
      ></v-text-field>
      <div
        class="pb-2"
        v-if="!userPwdCheckFlag"
        style="color: red; font-size: 14px"
      >
        비밀번호가 동일하지 않습니다.
      </div>
      ...
      <v-btn
        ...
        variant="flat"
        :disabled="
          email && userPwd && userPwdCheck && name && birth && fanCd === ''
        "
      >
        가입완료
      </v-btn>
